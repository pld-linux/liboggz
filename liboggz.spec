...
%description -l pl
liboggz to biblioteka umo¿liwiaj±ca prost± analizê i przeszukiwanie
...
opartych na Ogg formatach Annodex, co pozwala analizowaæ (ale nie
dekodowaæ) pliki w tych formatach. Kodowanie i dekodowanie ich
wymaga dodatkowych bibliotek - odpowiednio: libspeex, libvorbis,
libtheora, libannodex.

%package devel
Summary:	Header files for liboggz library
Summary(pl):	Pliki nag³ówkowe biblioteki liboggz
...
Pliki nag³ówkowe biblioteki liboggz.
